...
export JAVA_HOME=$DEVENV/java/jdk1.8.0_151
export MAVEN_HOME=$DEVENV/apache-maven/apache-maven-3.5.2
...
export PATH=$JAVA_HOME/bin:$MAVEN_HOME/bin:$ECLIPSE_HOME:$REDIS_HOME/bin:$GRADLE_HOME/bin:$TERRAFORM_HOME:$RUST:$EXERCISM:$LEIN:$PACKER:$PATH
